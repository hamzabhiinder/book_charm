...
//Ameer Dummy Code
      ...
      if (doc.exists) {
        ...
        if (docData != null) {
          ...
          docRef.update(data).then((value) {
            developer.log('Data updated successfully');
          }).catchError((error) {
            developer.log('Failed to update data: $error');
          });
        }
      } else {
        ...
        docRef.set(data).then((value) {
          developer.log('Data added successfully');
        }).catchError((error) {
          developer.log('Failed to add data: $error');
        });
      }
    }).catchError((error) {
      developer.log('Error fetching document: $error');
    });
  }
  ...
  Future<void> addWordPair(String english, String spanish) async {
    ...
    if (!wordPairs.any((pair) =>
      ...
      developer.log('lang ${lang}');

      addDictionaryDataToFirestore('${lang}', wordPairs);
    } else {
  ...
  Future<void> translateSelectedText(String? text) async {
    try {
      ...
      Translation translation =
          await translator.translate(selectedText, to: 'en');
