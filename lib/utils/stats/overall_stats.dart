...
class OverallStats {
  ...
  StreamController<OverallStats> _controller =
      StreamController<OverallStats>.broadcast();

  Stream<OverallStats> get statsStream => _controller.stream;

  void addListener(Function(OverallStats) listener) {
    _controller.stream.listen(listener);
  }

  void removeListener(Function(OverallStats) listener) {
    _controller.stream.drain<void>();
  }
