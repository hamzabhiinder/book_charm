...
class _LibraryScreenState extends State<LibraryScreen> {
  ...
  Future loadJsonDataFunction(context) async {
    final lang = Provider.of<LanguageProvider>(context, listen: false);
    try {
      log("Wotrking ${lang.selectedLanguageName}");
      String jsonString =
          await rootBundle.loadString('assets/data/booksData.json');
      setState(() {
        loadJsonData = json.decode(jsonString);
        categories = loadJsonData[lang.selectedLanguageName]
      ...
      body: categories.length == 0
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                List<dynamic> books = loadJsonData[lang.selectedLanguageName]
